...
class Miner:
    ...
    def connect(self,timeout):
        ...
        try:
            ...
            # print('данные некорректны ' + self.name +'\n',end='')
            self.err = err
    ...
    def get_start(self):
        ...
        try:
            ...
            self.err = err
            print(f"Ответ от майнера {self.name} некорректен")
        except ConnectionAbortedError as err:
            self.err = err
            print(f"майнер {self.name} разорвал соединение")
        except ConnectionResetError as err:
            self.err = err
            print(f"майнер {self.name} разорвал соединение")
        except socket.timeout as err:
            self.err = err
            print(f"майнер {self.name} долго отвечает")
        else:
